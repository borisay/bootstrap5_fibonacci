...
window.addEventListener('load', function (event) {
  var search = document.querySelector(".search-block-form");
  ...
  var opensearch = document.querySelector("div.open-search");
  ...
  var items = document.querySelectorAll('.field-type-paragraphs> .field-items > .field-item');
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (item.querySelector('.field-name-field-heading')) {
        var title = item.querySelector('.field-name-field-heading .field-item').innerHTML;
...
/******/ 	__webpack_require__.O(undefined, ["vendors-node_modules_babel_polyfill_lib_index_js-node_modules_bootstrap_dist_js_bootstrap_bun-15c01b"], function() { return __webpack_require__("../node_modules/@babel/polyfill/lib/index.js"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_babel_polyfill_lib_index_js-node_modules_bootstrap_dist_js_bootstrap_bun-15c01b"], function() { return __webpack_require__("./js/index.js"); })
