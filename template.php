 ...
 */
function bootstrap5_fibonacci_is_header($set)
{
  static $is_header;
  if (0 == strcmp($set, 'get')) {
    return $is_header;
 ...
 */
function bootstrap5_fibonacci_preprocess_layout(&$variables)
{
  ...
  foreach ($layout->content as $key => $block) {
    if ($block->module == 'system' && $block->delta == 'header') {
      bootstrap5_fibonacci_is_header(true);
    }
  }
 ...
 */
function bootstrap5_fibonacci_preprocess_page(&$variables)
{
 ...
 */
function bootstrap5_fibonacci_preprocess_header(&$variables)
{
  $variables['navigation'] = '';
  $navbar_menu_position = 'navbar-right';
  $variables['navbar_menu_position'] = 'd-flex justify-content-end';
  if ($navbar_position = theme_get_setting('bootstrap5_fibonacci_navbar_user_menu')) {
  ...
  if ($navbar_position = theme_get_setting('bootstrap5_fibonacci_navbar_position')) {
 ...
 */
function bootstrap5_fibonacci_links__header_menu($menu)
{
 ...
 * Implements hook_links().
 */
function bootstrap5_fibonacci_links__user_menu($menu)
{
  if ($navbar_menu_position = theme_get_setting('bootstrap5_fibonacci_navbar_menu_position')) {
    $menu['attributes']['class'][] = $navbar_menu_position;
  }
  foreach ($menu['links'] as $item => $link) {
...
// */
function bootstrap5_fibonacci_menu_tree__user_menu($variables)
{
  if ($navbar_position = theme_get_setting('bootstrap5_fibonacci_navbar_user_menu')) {
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_fieldset($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_button($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_email($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_textfield($variables)
{
  $variables['element']['#attributes']['class'][] = 'form-control';
...
// * @ingroup themeable
// */
function bootstrap5_fibonacci_textarea($variables)
{
  $variables['element']['#attributes']['class'][] = 'form-control';
...
// * @ingroup themeable
// */
function bootstrap5_fibonacci_checkbox($variables)
{
...
// * @ingroup themeable
// */
function bootstrap5_fibonacci_radio($variables)
{
  $variables['element']['#attributes']['class'][] = 'form-check-input';
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_form_element($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_password($variables)
{
  $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_search($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_select($variables)
{
 ...
 */
function bootstrap5_fibonacci_preprocess_table(&$variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_user_permission_description($variables)
{
  $description = array();
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_admin_block($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_system_admin_index($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_admin_page($variables)
{
 ...
 */
function bootstrap5_fibonacci_menu_local_tasks(&$variables)
{
  $output = '';
 ...
 * Implements hook_links().
 */
function bootstrap5_fibonacci_links__dropbutton($menu)
{
 ...
 */
function bootstrap5_fibonacci_menu_local_actions(&$variables)
{
 ...
 */
function bootstrap5_fibonacci_breadcrumb($variables)
{
 ...
 */
function bootstrap5_fibonacci_preprocess_breadcrumb(&$variables)
{
  $breadcrumb = &$variables['breadcrumb'];

  // Optionally get rid of the homepage link.
  $show_breadcrumb_home = theme_get_setting('bootstrap5_fibonacci_breadcrumb_home');
  if (!$show_breadcrumb_home) {
    array_shift($breadcrumb);
  }
  if (theme_get_setting('bootstrap5_fibonacci_breadcrumb_title') && !empty($breadcrumb)) {
    $item = menu_get_item();
 ...
 * @ingroup themeable
 */
function bootstrap5_fibonacci_container($variables)
{
 ...
 */
function bootstrap5_fibonacci_preprocess_views_view_table(&$variables)
{
 ...
 */
function bootstrap5_fibonacci_form_alter(array &$form, array &$form_state = array(), $form_id = null)
{
  if ($form_id) {
 ...
 */
function bootstrap5_fibonacci_node_add_list($variables)
{
 ...
 */
function bootstrap5_fibonacci_admin_block_content($variables)
{
  return bootstrap5_fibonacci_node_add_list($variables);
}
 ...
 */
function bootstrap5_fibonacci_preprocess_user_picture(&$variables)
{
 ...
 */
function bootstrap5_fibonacci_preprocess_comment(&$variables)
{
  if (theme_get_setting('bootstrap5_fibonacci_datetime')) {
 ...
 */
function bootstrap5_fibonacci_preprocess_node(&$variables)
{
  if (theme_get_setting('bootstrap5_fibonacci_datetime')) {
...
function bootstrap5_fibonacci_progress_bar($variables)
{
...
function bootstrap5_fibonacci_preprocess_paragraphs_item(&$variables, $hook)
{}
